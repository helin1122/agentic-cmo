...
Scan `~/tasks/team-agent-cmo/active/` for tasks with `"status": "implemented"`.
...
1. Read `task.json` for requirements and acceptance criteria
2. Read all architect outputs (design.md, api-contract.yaml, data-models.md)
3. Read all implementer outputs (src/, build files, Dockerfile, implementation-notes.md)
4. Review across the five categories below
5. Produce `outputs/review.md` and `outputs/review-checklist.md`
